...
if [ $failed_deployments -eq 0 ]; then
    ...
    echo "   • TMJ: https://tmj.gregpedromd.com"
    echo "   • Implants: https://implants.gregpedromd.com" 
    echo "   • Robotic: https://robotic.gregpedromd.com"
    echo "   • MedSpa: https://medspa.gregpedromd.com"
    echo "   • AboutFace: https://aboutface.gregpedromd.com"
    echo ""
    echo "🔧 Next steps:"
